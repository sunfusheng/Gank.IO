...
public class RefreshableScrollView extends ScrollView {
    ...
    private Runnable mRunnable = new Runnable() {
        ...
        public void run() {
            if (lastT == getScrollY() && !inTouch) {
                ...
                onScrollListener.onScrollStateChanged(RefreshableScrollView.this, OnScrollListener.SCROLL_STATE_IDLE, isBottom());
            }
        }
    };
     ...
     */
    public void setOnScrollListener(RefreshableLayout parent, OnScrollListener onScrollListener) {
        mParent = parent;
        this.onScrollListener = onScrollListener;
        mParent.addTouchLifeCycle(new RefreshableLayout.TouchLifeCycle() {
            @Override
