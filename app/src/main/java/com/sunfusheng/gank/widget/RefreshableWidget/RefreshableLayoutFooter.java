...
public class RefreshableLayoutFooter extends LinearLayout implements IFooterCallBack {
    ...
    @Override
    public void callWhenNotAutoLoadMore(final RefreshableLayout xRefreshView) {
...
//        setVisibility(show?VISIBLE:GONE);
    ...
    private void initView(Context context) {
        mContext = context;
        ViewGroup moreView = (ViewGroup) LayoutInflater.from(mContext).inflate(R.layout.layout_refreshable_footer, this);
